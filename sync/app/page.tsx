...
export default function Home() {
  ...
  return (
    <>
      {/* Estilos globales para fondo negro que cubre todo incluyendo safe areas y bounce scroll en iOS */}
      <style jsx global>{`
        html {
        ...
        /* Fix para el bounce scroll en iOS - pseudo elementos que extienden el fondo */
        html::before {
          content: "";
          position: fixed;
          top: -100vh;
      ...
      <div className="min-h-screen bg-black text-white overflow-x-hidden" style={{ backgroundColor: '#000000' }}>
        ...
        {/* Footer con padding extra para safe area inferior */}
        <footer className="border-t border-gray-900 py-12 px-4 bg-black" style={{ paddingBottom: 'max(env(safe-area-inset-bottom, 0px), 3rem)' }}>
